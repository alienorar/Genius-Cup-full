    ...
    <main className="flex flex-col gap-[40px]">
      ...
      <section className="custom-container">
        ...
        <div className="flex flex-col gap-0">
          ...
          <div className="bg-gradient-to-br from-[#E7ECFF] to-[#dde3f8] p-[10px] sm:p-[30px] md:p-[40px] lg:p-[60px] rounded-3xl rounded-tr-[40px] lg:rounded-tr-[60px] sm:rounded-[25px] md:rounded-[30px]   flex items-center justify-center lg:h-[704px] relative"
          >
